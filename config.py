...
OWNER_ID = int(getenv("OWNER_ID", 6670632940))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/DiillSe")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/alinasupportt")
